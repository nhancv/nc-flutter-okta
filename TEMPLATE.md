...
* Forked from nft: e7b34d6d8ef434dbaf3ce118e82d46207c871941
```
...
- Search and Replace All `okta` to new package name

### Change App display name

- Search and Replace All `Okta App` to new App display name

### Change App bundle id

- Search and Replace All `com.app.okta` to new App bundle id
